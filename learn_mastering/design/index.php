    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg"><b>Register Now</b></p>
                ...
                <form action="index.html" method="post">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="icheck-primary">
                                <input type="checkbox" id="gender" name="terms" value="female">
                                <label for="gender">
                                    Female
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="icheck-primary">
                                <input type="checkbox" id="gender" name="terms" value="male">
                                <label for="gender">
                                    Male
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="mobile" class="form-control" placeholder="Mobile No." name="mobile">
                                <div class="input-group-append">
                                    <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <textarea type="email" class="form-control" placeholder="Comment Here..." name="cmnt" style="height: 100px;"></textarea>
                        <div class="input-group-append">
                            <div class="input-group-text">
